        ...
        <AuthProvider>
          <Routes>
            <Route element={<Layout />}>
              ...
              <Route
                path="/all-books/add-book"
                element={<AddBookPage />}
              />{" "}
              {/* annoying */}
              <Route
                path="/all-books/update-book/:bookId"
                element={<UpdateBookPage />}
              />
              <Route
                path="/info-book/:bookId/update-book/:bookId"
                element={<UpdateBookPage />}
              />{" "}
              {/* annoying */}
              ...
              <Route
                path="/all-authors/add-author"
                element={<AddAuthorPage />}
              />{" "}
              {/* annoying */}
              <Route
                path="/all-authors/update-author/:authorId"
                element={<UpdateAuthorPage />}
              />
              <Route path="/all-users" element={<AllUsersPage />} />
              <Route
                path="/all-users/update-user/:userId"
